...
class DynamicOffer extends Component {
          ...
          Object.entries(data).forEach(([key, value]) => {
                  ...
                  .then(res => {
                    ...
                    Object.entries(res.data).forEach(([item, val]) => {
                      ...
                      if (
                        ...
                        this.setState({
                          viewPrices: false, 
                          messageError: "broker.addOfferOption.messages.errorPaymentMethod"
                        });
                        setTimeout(() => {
                          this.setState({
                            messageError: ""
            ...
            if (key === "limits") {
              this.setState({
                ...
                limitsAsk:
                  value.askBottom.toLocaleString("en-US", {
                ...
                limitsBid:
                  value.bidBottom.toLocaleString("en-US", {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 4
                  }) +
                  " - " +
  ...
  addConfig = () => {
    ...
    if (
      this.state.limitPriceToAdd !== "" &&
      this.state.marginPercentToAdd !== "" &&
      this.state.spreadPercentToAdd !== "" &&
      this.state.sourceToAdd !== "" &&
      ...
      if (this.state.operationToAdd === "ASK") {
        if (
          this.state.minPerOperationToAdd >= this.state.askBottomLimit &&
          ...
          if (
            this.state.marginPercentToAdd >= this.state.marginPercentAsk &&
            this.state.spreadPercentToAdd >= this.state.spreadPercentsAsk
          ) {
            if (this.state.limitPriceToAdd >= this.state.priceAskMin) {
              for (
                var i = 0;
                i < this.state.paymentMethodTypeToAdd.length;
                i++
              ) {
                var body = {
                  ...
                  source: this.state.sourceToAdd,
                  limitPrice: this.state.limitPriceToAdd,
                  marginPercent: this.state.marginPercentToAdd,
                  spreadPercent: this.state.spreadPercentToAdd,
              ...
              this.setState({
                messageError: "broker.addOfferOption.messages.limitPriceBid"
              });
              setTimeout(() => {
                this.setState({
                  messageError: ""
            ...
            this.setState({
              addLoad: false,
              messageError: "broker.addOfferOption.messages.limitPercents"
            });
            setTimeout(() => {
              this.setState({
                messageError: ""
          ...
          this.setState({
            messageError: "broker.addOfferOption.messages.limitExceded"
          });
          setTimeout(() => {
            this.setState({
              messageError: ""
        ...
        if (
          this.state.minPerOperationToAdd >= this.state.bidBottomLimit &&
          this.state.totalAmountToAdd <= this.state.bidTopLimit &&
          this.state.maxPerOperationToAdd <= this.state.bidTopLimit &&
          this.state.maxPerOperationToAdd <= this.state.totalAmountToAdd
        ) {
          if (
            this.state.marginPercentToAdd >= this.state.marginPercentBid &&
            this.state.spreadPercentToAdd >= this.state.spreadPercentsBid
          ) {
            if (this.state.limitPriceToAdd <= this.state.priceBidMax) {
              this.setState({ addLoad: true });
              for (
                var i = 0;
                i < this.state.paymentMethodTypeToAdd.length;
              ...
              this.setState({
                addLoad: false,
                messageError: "broker.addOfferOption.messages.limitPriceAsk"
              });
              setTimeout(() => {
                this.setState({
                  messageError: ""
      ...
      this.setState({ addLoad: false });
      this.setState({
        messageError: "broker.addOfferOption.messages.incompleteInfo"
      });
      setTimeout(() => {
        this.setState({
          messageError: ""
  ...
  render() {
    ...
    if (this.state.messageSuccess) {
      messageAddSuccess = (
        <Message positive>
          <Message.Header>
            {t("broker.addOfferOption.messages.addOffer")}
          </Message.Header>
    ...
    return (
      <Form key={this.state.keyForm}>
                          ...
                          {referencePrice.toUsd !== undefined && (
                            <Label>
                              ...
                              <Label.Detail>
                                <NumberFormat
                                  value={
                                    this.state.referenceHeaderFlag !==
                                    "ethereum"
                                      ? this.floorDecimals(
        ...
        <Form.Group widths="equal">
          <Form.Field>
            ...
            <Select
              ...
              onChange={this.pickOperation.bind(this)}
            />
          </Form.Field>
          <Form.Field>
        ...
        <Form.Group widths="equal">
          <Form.Field>
            <label>{t("broker.addOfferOption.source")}</label>
            <Select
              placeholder={t("broker.addOfferOption.source")}
              options={this.sourceOptions}
              onChange={this.pickSource}
            />
          </Form.Field>
          <Form.Field>
            <label>{t("broker.addOfferOption.marginPercentage")}</label>
            <NumberFormat
              value={this.state.marginPercentToAdd}
              ...
              onValueChange={values => {
                const { value } = values;
                this.setState({ marginPercentToAdd: parseFloat(value) });
              }}
              suffix={" " + "%"}
            />
          </Form.Field>
          <Form.Field>
            <label>{t("broker.addOfferOption.propagationPercentage")}</label>
            <NumberFormat
              value={this.state.spreadPercentToAdd}
              ...
              onValueChange={values => {
                const { value } = values;
                this.setState({ spreadPercentToAdd: parseFloat(value) });
              }}
              suffix={" " + "%"}
            />
          </Form.Field>
        ...
        <Form.Group widths="equal">
          <Form.Field>
            ...
            {this.state.currencyToAdd !== "" ? (
              <NumberFormat
                value={this.state.limitPriceToAdd}
                ...
                onValueChange={values => {
                  const { value } = values;
                  this.setState({ limitPriceToAdd: parseFloat(value) });
                }}
                suffix={
...
export default translate(DynamicOffer);
